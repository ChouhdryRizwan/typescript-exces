...
async function welcome_title() {
    console.clear();
    const title = chalkAnimation.rainbow("  ___ Let's Start Countdown Timer ___");
    await sleep();
    title.stop();
}
await welcome_title();
async function setData(name, regex) {
